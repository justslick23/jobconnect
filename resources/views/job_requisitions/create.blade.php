            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Create New Job Requisition</div>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('job-requisitions.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" 
                                          id="editor" 
                                          class="form-control"
                                          placeholder="Describe the job responsibilities and requirements">{{ old('description') }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="requirements" 
                                          ...
                                          class="form-control" 
                                          rows="4"
                                          placeholder="Any additional requirements or notes">{{ old('requirements') }}</textarea>
                            </div>
                                ...
                                <select name="required_skills[]" 
                                    ...
                                    @foreach($skills as $skill)
                                        <option value="{{ $skill->id }}" 
                                                {{ collect(old('required_skills'))->contains($skill->id) ? 'selected' : '' }}>
                                            {{ $skill->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="card-action">
                                <button type="submit" class="btn btn-success">
                                    <i class="fas fa-check"></i> Create Job Requisition
                                </button>
